...
pOptions["validateFlatListExport"]={def:true,ind:2,name:'Validate Flat List Result (May be slow)'};
pOptions["flatListDefaultVal"]={def:'NULL',ind:3,name:'Value to display when no data is found.'};
pOptions["spreadsheetView"]={def:true,ind:0,name:'Sheet Grid Preview (May be slow for large exports)'};
